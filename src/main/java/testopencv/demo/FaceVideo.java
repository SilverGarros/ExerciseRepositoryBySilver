...
public class FaceVideo {
    ...
    static int i = 0;
    private static final String PATH_PREFIX = "G:\\";
    ...
    private static final String PATH_OPENCV_OPENCV=currentDirectory+"/src/main/resources/lib/opencv/opencv_java490.dll";
    ...
    static {
        ...
        if (os != null && os.toLowerCase().startsWith("windows")) {
            ...
            System.load(PATH_OPENCV_OPENCV);
//            ClassLoader.getSystemResource("dlls/opencv_java470.dll");
        ...
        String property = PATH_haarcascade_frontalface_alt;
    ...
    public static void main(String[] args) {
        ...
        face("liuguangshuo.png");

        // 4- 比对本地2张图的人脸相似度 （越接近1越相似）
        double compareHist = compare_image(PATH_PREFIX + "liuguangshuo.png", PATH_PREFIX + "face.png");
    ...
    public static Mat getFace(Mat image) {
        ...
        CascadeClassifier facebook = new CascadeClassifier(PATH_haarcascade_frontalface_alt);
        // 2 特征匹配类
